...
export type BaseMacroFn<in out TypedRoute extends RouteSchema = {}, in out Singleton extends SingletonBase = {
    ...
    [K in keyof any]: (...a: any) => void | {
        ...
        onAfterHandle?(fn: MaybeArray<OptionalHandler<TypedRoute, Singleton>>): unknown;
        onAfterHandle?(options: MacroOptions, fn: MaybeArray<OptionalHandler<TypedRoute, Singleton>>): unknown;
